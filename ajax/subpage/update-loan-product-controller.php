...
$txtProductid = filter_var($_POST['txtProductid'], FILTER_DEFAULT);

try {
    $stmt = $db->prepare('UPDATE `tbl_loan_product` 
    SET 
        ...
        DefaultLoanTerm = :DefaultLoanTerm,
        MinimumLoanTerm = :MinimumLoanTerm,
