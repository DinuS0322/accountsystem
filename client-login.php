                                        ...
                                        <div class="card-body p-5" id="divLoginFormCard">
                                            ...
                                            <div id="login-form">
                                                <div class="mb-4 form-floating">
                                                    <input class="form-control no-space" id="txtLoginNic" type="text" placeholder="Nic Number" autocomplete="off">
                                                    <label for="txtLoginEmail">Nic Number</label>
                                                </div>
...
<!-- Custom JS -->
<script src="js/custom/client-login.js?v=<?= $cashClear ?>"></script>
<!-- Custom JS -->
