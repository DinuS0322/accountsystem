<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link  <?= activeBar(['deposit-account', 'view-account', 'create-account', 'account-transfer-dashboard', 'transection-history'])  ?> " href="#" data-bs-target="#Accountingview" data-bs-toggle="collapse">
            ...
            <ul id="Accountingview" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    ...
                    <a class="nav-link <?= activeBar(['account-transfer-dashboard']) ?> mt-2" href="index.php?page=all-subpages&subpage=account-transfer-dashboard">
                        <i class="fas fa-file-invoice-dollar" style="font-size: 16px;"></i> <span>Balance Transfer</span>
                    </a>
                    <a class="nav-link <?= activeBar(['transection-history']) ?> mt-2" href="index.php?page=all-subpages&subpage=transection-history">
                        <i class="fas fa-file-invoice-dollar" style="font-size: 16px;"></i> <span>Transaction History</span>
                    </a>
                    <a class="nav-link <?= activeBar(['all-deposit-account']) ?> mt-2" href="index.php?page=all-subpages&subpage=all-deposit-account">
                        <i class="fas fa-file-invoice-dollar" style="font-size: 16px;"></i> <span>Deposit</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link  <?= activeBar(['loan-manage-product', 'loan-manage-charge', 'view-loan-charge', 'view-loan-product', 'create-loan', 'view-loan', 'view-separate-loan', 'add-repayment'])  ?> " href="#" data-bs-target="#Loansview" data-bs-toggle="collapse">
                <i class="fa fa-tasks" aria-hidden="true"></i><span>Loans</span>
            ...
            <ul id="Loansview" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a class="nav-link <?= activeBar(['view-loan']) ?> mt-2" href="index.php?page=all-subpages&subpage=view-loan">
                        <i class="fa fa-tasks" style="font-size: 16px;"></i> <span>View Loans</span>
                    </a>
                    ...
                    <a class="nav-link <?= activeBar(['loan-manage-product', 'view-loan-product']) ?> mt-2" href="index.php?page=all-subpages&subpage=view-loan-product">
                        <i class="fa fa-tasks" style="font-size: 16px;"></i> <span>Manage Products</span>
                    </a>
                    <a class="nav-link <?= activeBar(['view-loan-charge', 'loan-manage-charge']) ?> mt-2" href="index.php?page=all-subpages&subpage=view-loan-charge">
                        <i class="fa fa-tasks" style="font-size: 16px;"></i> <span>Manage Charges</span>
                    </a>
        ...
        <li class="nav-item">
            <a class="nav-link <?= activeBar(['all-repayments']) ?>" href="index.php?page=all-subpages&subpage=admin-all-repayments">
                <i class="fa fa-tasks" aria-hidden="true"></i> <span>Repayments</span>
            </a>
        </li>
        ...
        <li class="nav-item hidden">
            <a class="nav-link  <?= activeBar(['#'])  ?> " href="#" data-bs-target="#Expenseview" data-bs-toggle="collapse">
                <i class="fa fa-tasks" aria-hidden="true"></i><span>Expense</span>
            ...
            <ul id="Expenseview" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a class="nav-link <?= activeBar(['#']) ?> mt-2" href="#">
                        <i class="fa fa-tasks" style="font-size: 16px;"></i> <span>View Expense</span>
                    </a>
                    <a class="nav-link <?= activeBar(['#']) ?> mt-2" href="#">
        ...
        <li class="nav-item hidden">
            <a class="nav-link  <?= activeBar(['#'])  ?> " href="#" data-bs-target="#Incomeview" data-bs-toggle="collapse">
                <i class="fa fa-tasks" aria-hidden="true"></i><span>Income</span>
                <i class="fa fa-chevron-down arrow" style="margin-left: 93px;"></i>
            </a>
            <ul id="Incomeview" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a class="nav-link <?= activeBar(['#']) ?> mt-2" href="#">
                        <i class="fa fa-tasks" style="font-size: 16px;"></i> <span>View Income</span>
                    </a>
                    <a class="nav-link <?= activeBar(['#']) ?> mt-2" href="#">
        ...
        <li class="nav-item">
            <a class="nav-link  <?= activeBar(['add-users', 'view-users'])  ?> " href="#" data-bs-target="#Usersview" data-bs-toggle="collapse">
                <i class="fa fa-tasks" aria-hidden="true"></i><span>Users</span>
                <i class="fa fa-chevron-down arrow" style="margin-left: 105px;"></i>
            </a>
            <ul id="Usersview" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a class="nav-link <?= activeBar(['view-users']) ?> mt-2" href="index.php?page=all-subpages&subpage=view-users">
                        <i class="fa fa-tasks" style="font-size: 16px;"></i> <span>View Users</span>
                    </a>
                    <a class="nav-link <?= activeBar(['add-users']) ?> mt-2" href="index.php?page=all-subpages&subpage=add-users">
                        <i class="fa fa-plus-square" style="font-size: 16px;"></i> <span>Create Users</span>
                    </a>
                    <a class="nav-link <?= activeBar(['view-client-users']) ?> mt-2" href="index.php?page=all-subpages&subpage=view-client-users">
                        <i class="fa fa-plus-square" style="font-size: 16px;"></i> <span>Client Users</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link  <?= activeBar(['other-settings'])  ?> " href="#" data-bs-target="#Settingsview" data-bs-toggle="collapse">
                <i class="fa fa-tasks" aria-hidden="true"></i><span>Settings</span>
            ...
            <ul id="Settingsview" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a class="nav-link <?= activeBar(['#']) ?> mt-2" href="index.php?page=all-subpages&subpage=system-settings">
                        <i class="fa fa-tasks" style="font-size: 16px;"></i> <span>System Settings</span>
                    </a>
        ...
        <li class="nav-item">
            <a class="nav-link <?= activeBar(['reports']) ?>" href="index.php?page=all-subpages&subpage=reports">
                <i class="fa fa-tasks" aria-hidden="true"></i> <span>Reports</span>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link <?= activeBar(['activity-log']) ?>" href="index.php?page=all-subpages&subpage=activity-log">
                <i class="fa fa-tasks" aria-hidden="true"></i> <span>Activity Log</span>
            </a>
        </li>
