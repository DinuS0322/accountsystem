...
$sqlPMethod = "SELECT * FROM tbl_client_users where id = $SESS_USER_ID";
...
<section class="user-info">
        ...
        <div class="card-body pt-3">
            ...
            <div class="row">
                <div class="mb-2 col-md-6">
                    ...
                    <input type="text" id="txtClientFirstName" class="form-control" autocomplete="off" value="<?= $firstName ?>">
                </div>
                <div class="mb-2 col-md-6">
                    <label for="txtLastName" class="col-md-12 pl-0 pt-2 strong">
                        Last Name <span class="text-danger">*</span>
                    </label>
                    <input type="text" id="txtClientLastName" class="form-control" autocomplete="off" value="<?= $lastName ?>">
                </div>
                <div class="mb-2 col-md-6">
                    <label for="txtPhone" class="col-md-12 pl-0 pt-2 strong">
                        Nic Number <span class="text-danger">*</span>
                    </label>
                    <input type="text" id="txtClientNic" class="form-control" autocomplete="off" value="<?= $nicNumber ?>" readonly>
                </div>
    ...
    <div class="float-end">
      <a href="index.php?page=all-subpages&subpage=client-change-password"> <button class="btn btn-secondary mb-1" id="btnClientChangePassword">Change Password</button></a> 
        <button class="btn btn-primary mb-1" id="btnUpdateClientProfile">Save Changes</button>
    </div>
</section>
