<div class="row">
    <div class="table-responsive">
        <table class="table table-striped table-align-left" id="viewAllLoans" style="width: 100%;">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Loan Id</th>
            ...
            <tbody>
                ...
                try {
                    ...
                    while ($row = $stmt->fetchObject()) {
                        ...
                        echo "<tr>";
                        echo "<td>$i</td>";
                        echo "<td><a href='index.php?page=all-subpages&subpage=view-separate-loan&id=$id'>$loanIdView</a></td>";
