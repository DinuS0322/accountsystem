<div class="card shadow">
    <div class="card-header header-bg">
        <i class="fa fa-tasks"></i> View Collection Reports
    </div>
    <div class="card-body">
        <div class="row mt-3">
        ...
        <div class="row mt-3">
            ...
            <button type="button" class="btn btn-primary" id="btnViewCollection"><i class="bi bi-funnel-fill"></i> Filter</button>
            </div>
        </div>
        <div id="viewCollectionDiv"></div>
        <div id="viewCollectionTotalDiv"></div>
    </div>
</div>
